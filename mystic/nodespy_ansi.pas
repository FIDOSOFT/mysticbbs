...
Const
  IMAGEDATA_WIDTH=80;
  IMAGEDATA_DEPTH=25;
  IMAGEDATA_LENGTH=1110;
  IMAGEDATA : array [1..1110] of Char = (
    ...
    'O','N','D',#24,#24, #9,#17,'°',#25, #9,#15,'E','S','C', #7,'/',#15,
    'Q','u','i','t',#25, #4,'A','R','R','O','W','S', #7,'/',#15,'S','e',
    'l','e','c','t',#25, #4,'E','N','T','E','R', #7,'/',#15,'S','n','o',
    'o','p',#25, #4,'S','P','A','C','E', #7,'/',#15,'L','o','c','a','l',
    #25, #8, #9,'°',#24);
Begin
